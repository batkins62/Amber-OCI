...
public abstract class BaseCommand
{
	...
	protected GlobalHandler global = plugin.getGlobalHandler();
	...
	public boolean run(CommandSender csender, String[] preArgs, String cmd)
	{
		...
		{
			Messager.sendMessage(sender, Colors.Red, "Wrong arguments supplied!");
			sendUsage();
			return true;
		}
		...
		if (!permission())
		{
			Messager.sendMessage(sender, Colors.Red, "You do not have permission to do that!");
			return false;
		}
	...
	{
		Messager.sendMessage(sender, Colors.Red, "/" + usedCommand + " " + name + " " + usage);
	}
